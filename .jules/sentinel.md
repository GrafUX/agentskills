...
## 2026-08-16 - Fix XML Injection in prompt generation\n**Vulnerability:** manual string building for XML blocks used html.escape which doesn't escape quotes by default, posing an XML injection risk for attributes.\n**Learning:** Use xml.sax.saxutils.escape with explicit quote mappings when manually building XML blocks.\n**Prevention:** Apply XML specific utilities for encoding instead of HTML utilities.
