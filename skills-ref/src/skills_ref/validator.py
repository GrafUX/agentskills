...
from .parser import _replace_whitespace, _safe_name, find_skill_md, parse_frontmatter
...
def _validate_name(name: str, skill_dir: Path) -> list[str]:
    ...
    display_name = _replace_whitespace(_safe_name(name, max_len=100))
...
def _validate_metadata_dict(custom_metadata: dict) -> list[str]:
    ...
    for k, v in custom_metadata.items():
        ...
        display_k = _replace_whitespace(_safe_name(k, max_len=100))
